...
/**
 * Constants for Firestore collection paths used in the scheduling feature
 */
object FirestoreCollection {
    const val TEACHING_SLOT_PRESETS = "teachingSlotPresets"
    const val VOLUNTEER_PRESETS = "volunteerPresets"
